...
<template>
  <div class="flex justify-center items-center w-full h-fit bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
    <div class="w-full h-fit max-w-md space-y-8">
      <div>
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input id="password" name="password" type="password" autocomplete="current-password" required
                   ...
                   placeholder="输入验证密码" autofocus minlength="6"/>
          </div>
        </div>
